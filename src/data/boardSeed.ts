...
/**
 * 커뮤니티 게시판 예시 글.
 * 실제 사용자의 후기가 아니라 게시판 사용법을 보여주는 샘플이며, 화면에 "예시 글" 배지가 붙는다.
 * 실제 브랜드 제품에 대한 가짜 후기로 오해되지 않도록 제품은 구체적 상품명 대신 유형으로만 적는다.
 * 실제 서비스에서는 Supabase board_posts 테이블의 글이 함께 표시된다.
 */
