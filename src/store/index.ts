...
export const repo: Repository = {
  ...
  shareProductPhoto: (productId, url) => repoRef.current.shareProductPhoto(productId, url),
  unshareProductPhoto: (productId) => repoRef.current.unshareProductPhoto(productId),
